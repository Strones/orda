import { InvalidParams } from '@fitbit/jsonrpc-ts';
...
var BulkData = (function () {
    function BulkData() {
        ...
        this.handleWrite = function (_a) {
            ...
            if (encoding !== 'base64') {
                throw new InvalidParams('Unsupported encoding', { encoding: encoding });
            }
            if (!isBase64(data)) {
                throw new InvalidParams('Data is not valid for encoding', { encoding: encoding });
            }
