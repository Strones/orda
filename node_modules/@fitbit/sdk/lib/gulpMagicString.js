...
async function mergeSourceMaps(inMap, outMap) {
    const generator = source_map_1.SourceMapGenerator.fromSourceMap(await new source_map_1.SourceMapConsumer(inMap));
    generator.applySourceMap(await new source_map_1.SourceMapConsumer(outMap));
